...
export type DeleteCharacterMutation = { __typename?: 'Mutation', deleteCharacter: { __typename?: 'Character', id: string } };
...
export type CreateSpecialMoveMutation = { __typename?: 'Mutation', createSpecialMove: { __typename?: 'SpecialMove', id: string, name: string, description?: string | null, usedBy: Array<{ __typename?: 'Character', id: string, name: string }> } };

export type GetSpecialMovesQueryVariables = Exact<{
  after?: InputMaybe<Scalars['DateTime']['input']>;
}>;
...
export type DeleteSpecialMoveMutation = { __typename?: 'Mutation', deleteSpecialMove: { __typename?: 'SpecialMove', id: string } };
...
export const GetSpecialMovesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSpecialMoves"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"specialMovesCount"}},{"kind":"Field","name":{"kind":"Name","value":"allSpecialMoves"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"usedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<GetSpecialMovesQuery, GetSpecialMovesQueryVariables>;
export const DeleteSpecialMoveDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteSpecialMove"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteSpecialMove"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<DeleteSpecialMoveMutation, DeleteSpecialMoveMutationVariables>;
